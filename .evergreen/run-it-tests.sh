...
provision_ssl () {
  ...
  # Set System property arguments for SSL
  export SSL_SYSTEM_PROPERTIES="-Djavax.net.ssl.keyStoreType=pkcs12 -Djavax.net.ssl.keyStore=`pwd`/client.pkc -Djavax.net.ssl.keyStorePassword=bithere -Djavax.net.ssl.trustStoreType=jks -Djavax.net.ssl.trustStore=`pwd`/mongo-truststore -Djavax.net.ssl.trustStorePassword=ssl.trustStorePassword=hithere"
...
./sbt -java-home $JAVA_HOME ++${SCALA_VERSION} it:test -Dorg.mongodb.test.uri=${MONGODB_URI} ${SSL_SYSTEM_PROPERTIES}
