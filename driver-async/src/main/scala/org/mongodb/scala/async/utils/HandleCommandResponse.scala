 ...
 */
package org.mongodb.scala.async.utils
...
trait HandleCommandResponse {
   ...
   */
  protected[scala] def handleNameSpaceErrors(commandFuture: Future[CommandResult]) =
   ...
   * @return
   */
  protected[scala] def handleErrors(commandFuture: Future[CommandResult]): Future[CommandResult] =
