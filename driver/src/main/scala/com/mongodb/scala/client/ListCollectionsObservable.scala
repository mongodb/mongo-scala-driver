 ...
 */
case class ListCollectionsObservable[T](wrapped: ListCollectionsIterable[T]) extends Observable[T] {
   ...
   * @return this
   */
  def filter(filter: Bson): ListCollectionsObservable[T] = {
   ...
   * @return this
   */
  def maxTime(duration: Duration): ListCollectionsObservable[T] = {
