...
import com.mongodb.scala.Helpers.{ DefaultsTo, classTagToClassOf }
...
import com.mongodb.scala.client.ObservableHelper.{ observe, observeAndFlatten, observeLong }
...
case class MongoCollection[T](private val wrapped: JMongoCollection[T]) {
   ...
   */
  def insertOne(document: T): Observable[Void] = observe(wrapped.insertOne(document, _: SingleResultCallback[Void]))
   ...
   *         com.mongodb.DuplicateKeyException or com.mongodb.MongoException
   */
  def insertMany(documents: List[_ <: T]): Observable[Void] =
   ...
   *         com.mongodb.DuplicateKeyException or com.mongodb.MongoException
   */
  def insertMany(documents: List[_ <: T], options: InsertManyOptions): Observable[Void] =
