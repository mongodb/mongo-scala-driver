 ...
 */
case class DistinctObservable[T](private val wrapped: DistinctIterable[T]) extends Observable[T] {
  /**
   ...
   * @return this
   */
  def filter(filter: Bson): DistinctObservable[T] = {
   ...
   * @return this
   */
  def maxTime(duration: Duration): DistinctObservable[T] = {
